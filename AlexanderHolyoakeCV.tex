...
{\begin{tabular}{ll}
\textbf{Address:} & 10 Rawson Close\\
 & Oxford OX2 8BS\\
\end{tabular}}
{\begin{tabular}{ll}
\textbf{Email:} & ajholyoake@gmail.com\\
\textbf{Tel:} & 07979752339 \\
\end{tabular}}
{\begin{tabular}{ll}
...
2012- & \textbf{Performance Analyst at Caterham F1} Vehicle Dynamic and Aerodynamic analysis of car performance. Heavy emphasis on coding new, reusable tools in MATLAB and Python with web-based interfaces\\
